...
class MainFrameState extends State<MainFrame> {
  ...
  void _onCardTap(String title, String subtitle) {
    setState(() {
      _selectedCardTitle = title;
      _selectedCardSubtitle = subtitle;
    });
  }

  @override
  Widget build(BuildContext context) {
    Widget page = HomeScreen(onCardTap: _onCardTap);
